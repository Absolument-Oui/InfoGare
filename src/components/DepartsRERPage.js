...
import { get, query, ref, getDatabase, orderByChild } from 'firebase/database';
import { getAuth } from 'firebase/auth';

import { createRoot } from 'react-dom';

import TwoRowDepartRER from './TwoRowDepartRER';
import OneRowDepartRER from './OneRowDepartRER';

class DepartsRERPage extends Component {
    constructor(props) {
        super(props);
        this.state = {};
    ...
    render() {
        return (
            <div className='rows rows-departures'>
                ...
                <div className='row-group row-group-bar row-group-bar-purple'>
                    <div className='row'>
